    ...
    <>
      ...
      <div className="w-full min-h-screen bg-gradient-to-br from-black via-[#1a0e30] to-[#120b24] flex flex-col items-center md:pb-10 overflow-hidden">
        ...
        <div className="w-11/12 text-center py-10">
          ...
          <h2 className="text-transparent bg-gradient-to-r from-purple-400 to-[#341B66] bg-clip-text text-5xl font-bold" data-aos="fade-up" data-aos-duration="2000">
            About Me
          </h2>
        </div>
        ...
        <div className="w-11/12 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 pb-10">
          ...
          <div data-aos="fade-right" data-aos-duration="2000" className="relative md:w-1/3 sm:w-96">
            <div className="absolute top-4 left-4 w-full h-full bg-gradient-to-r from-[#4b3e6e] to-[#2b0e66] rounded-2xl transform rotate-3"></div>
          ...
          <div className="flex-1 text-gray-300 md:p-6 p-2" data-aos="fade-left" data-aos-duration="2000">
            ...
            <p className="text-gray-400 text-md leading-relaxed">
              I have completed my Bachelor of Social Science (BSS) from MC College in 2022.
            ...
            <div className="mt-6 grid md:grid-cols-3 grid-cols-2 gap-3">
            {
              skills.map((skill, idx) => 
                <SkillsAbout key={idx} skill={skill} />
            )
            }
            </div>
            ...
            <div className="mt-10 flex gap-4">
              <a href="/resume.pdf" className="flex items-center gap-2 md:px-4 px-3 py-2 bg-gradient-to-r from-[#4b3e6e] to-[#2b0e66] text-white rounded-lg text-sm font-medium transition duration-300 hover:scale-105 shadow-md">
                <RiDownload2Line className="text-lg" />
                Download CV
              </a>
              <a href="https://web.whatsapp.com/send?phone=+8801581543966" className="flex items-center gap-2 md:px-4 px-3 py-2 bg-transparent border border-[#341B66] text-purple-400 rounded-lg text-sm font-medium transition duration-300 hover:bg-[#341B66] hover:text-white hover:scale-105 shadow-md">
                Contact
